        ...
        <body>
            <div class="container">
                ...
                <div class="public-warning">
                    <h3>⚠️ 外网访问提醒</h3>
                    <p><strong>访问方式：</strong>外网直接访问</p>
                    <p><strong>安全提示：</strong>此服务已配置为外网访问，请注意网络安全</p>
                    <p><strong>建议：</strong>在生产环境中请配置HTTPS和认证</p>
                </div>
                ...
                <div class="status">
                    <h3>🎯 外网访问地址</h3>
                    <p><strong>外网地址：</strong>http://外网IP:8899</p>
                    <p><strong>本地地址：</strong>http://localhost:8899</p>
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`📍 外网地址: http://$(hostname -I | awk '{print $1}'):${PORT}`);

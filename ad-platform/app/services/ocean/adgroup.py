...
class AdGroupService:
    ...
    def create(
        ...
        **kwargs
        ...
        result = self.client.post_json(
            self.CREATE_URL, json_data={"adgroup_data": data}
        )
        return {
    ...
    def update(self, advertiser_id: str, adgroup_id: int, **kwargs) -> Dict[str, Any]:
        """
        更新广告组
        ...
        Returns:
            更新结果
        """
        data = {"advertiser_id": advertiser_id, "adgroup_id": adgroup_id, **kwargs}
        self.client.post_json(self.UPDATE_URL, json_data={"adgroup_data": data})
        return {"success": True}

    def update_status(
        self, advertiser_id: str, adgroup_id: int, opt_status: str = "enable"
    ) -> Dict[str, Any]:
        """
        更新广告组状态
    ...
    def delete(self, advertiser_id: str, adgroup_id: int) -> Dict[str, Any]:
        """
        删除广告组

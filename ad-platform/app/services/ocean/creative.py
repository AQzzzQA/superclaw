...
class CreativeService:
    ...
    def create(
        ...
        **kwargs
        ...
        result = self.client.post_json(
            self.CREATE_URL, json_data={"creative_data": data}
        )
        return {
    ...
    def update(self, advertiser_id: str, creative_id: int, **kwargs) -> Dict[str, Any]:
        """
        更新创意
        ...
        Returns:
            更新结果
        """
        data = {"advertiser_id": advertiser_id, "creative_id": creative_id, **kwargs}
        self.client.post_json(self.UPDATE_URL, json_data={"creative_data": data})
        return {"success": True}

    def update_status(
        self, advertiser_id: str, creative_id: int, opt_status: str = "enable"
    ) -> Dict[str, Any]:
        """
        更新创意状态
    ...
    def delete(self, advertiser_id: str, creative_id: int) -> Dict[str, Any]:
        """
        删除创意

...
class CampaignService:
    ...
    def create(
        ...
        **kwargs
        ...
        result = self.client.post_json(
            self.CREATE_URL, json_data={"campaign_data": data}
        )
        return {
    ...
    def update(self, advertiser_id: str, campaign_id: int, **kwargs) -> Dict[str, Any]:
        """
        更新广告计划
        ...
        Returns:
            更新结果
        """
        data = {"advertiser_id": advertiser_id, "campaign_id": campaign_id, **kwargs}
        self.client.post_json(self.UPDATE_URL, json_data={"campaign_data": data})
        return {"success": True}

    def update_status(
        self, advertiser_id: str, campaign_id: int, opt_status: str = "enable"
    ) -> Dict[str, Any]:
        """
        更新广告计划状态
    ...
    def delete(self, advertiser_id: str, campaign_id: int) -> Dict[str, Any]:
        """
        删除广告计划
